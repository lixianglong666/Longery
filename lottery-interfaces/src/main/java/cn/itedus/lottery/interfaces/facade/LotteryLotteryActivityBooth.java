 ...
 */
@Controller
public class LotteryLotteryActivityBooth implements ILotteryActivityBooth {

    private Logger logger = LoggerFactory.getLogger(LotteryLotteryActivityBooth.class);
